	...
	Football Player Information Page
		loadPlayersPage method:
			...
			purpose: This method will populate the dropdown menu to allow the
				...
				{
					for(int = 0; int < players.length; int++)
					{
						var temp = document.createElement('a');
						temp.setAttribute('class', "dropdown-item");
						temp.setAttribute('href',"#");
						temp.setAttribute('onclick',"switchPlayers(" + int.toString(10) + ")");
						temp.innerHTML = players[int].name;
						document.getElementById("player_selector").appendChild(temp);
					}
				}
/*
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("avg_p_yards").innerHTML = parseInt(players[playerNum].pass_yards)/parseInt(players[playerNum].games_played);
	document.getElementById("avg_r_yards").innerHTML = parseInt(players[playerNum].rushing_yards)/parseInt(players[playerNum].games_played);
	document.getElementById("avg_rec_yards").innerHTML = parseInt(players[playerNum].receiving_yards)/parseInt(players[playerNum].games_played);
}
